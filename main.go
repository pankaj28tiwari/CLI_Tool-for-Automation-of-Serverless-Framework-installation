...
func main() {
	...
	fmt.Println("************************ DEVELOPER--> Pankaj Tiwari ***********************************")
	fmt.Println("************************ TESTED FOR--> Linux BASED SYSTEMS ***********************************")
	askForK8sChoice()
}
...
func installAnsible() {
	...
	if log == "Yes" {
		...
		runCommand("sudo apt install software-properties-common")
		runCommand("sudo add-apt-repository --yes --update ppa:ansible/ansible")
